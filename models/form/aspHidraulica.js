...
const AspHidraulica = mongoose.model('AspHidraulica', aspSchema);
const AspHidraulicaHist = mongoose.model('AspHidraulicaHist', aspHistSchema);

module.exports = { AspHidraulica, AspHidraulicaHist };
