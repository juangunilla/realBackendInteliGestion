...
app.use('/api/analisisderiego', formEditAccess, require('./routes/form/analisisDeRiego'));
app.use('/api/ddjjcancerigenos', formEditAccess, require('./routes/form/ddjjCancerigenos'));
app.use('/api/cargatermica', formEditAccess, require('./routes/form/cargaTermica'));
app.use('/api/ventilacion', formEditAccess, require('./routes/form/ventilacion'));
app.use('/api/controlestiabs', formEditAccess, require('./routes/form/controlEstiabs'));
app.use('/api/certifmaqherram', formEditAccess, require('./routes/form/certifMaqHerram'));
app.use('/api/convenioprof', formEditAccess, require('./routes/form/convenioProf'));
app.use('/api/relevamientotrimesautoelev', formEditAccess, require('./routes/form/relevamientoTrimesAutoelev'));
app.use('/api/srtres90515', formEditAccess, require('./routes/form/srtRes90515'));
